...
void* http_req(void* data)
{
	...
	char *req,tmp_var[50],doc_root[100],line[65000],header[6000],header1[6000],demoRpath[100],buf[6500], *filePath,*ftype,*type,status1[100]="200 OK",status[100]="404 FILE NOT FOUND",*tmp_ptr1,*tmp_ptr2,tmp_ptr3[100],*tmp_ptr4,*tmp_ptr5,tmp_ptr6[100]="/",tmp_ptr7[100],tmp_ptr8[100],*tmp_ptr9[100],buf2[6500]; 
...
int nsfd,portnum;// fd will be used as a socket descriptor
